...
import type { DefaultBodyType, RequestHandler, StrictRequest, WebSocketHandler } from 'msw';
...
/**
 * A helper type to work with MSW workers or servers created with
 * `setupWorker` or `setupServer`.
 */
