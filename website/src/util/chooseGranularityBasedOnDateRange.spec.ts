...
describe('chooseGranularityBasedOnDateRange', () => {
    ...
    it('should return "month" for date ranges over 2 years but less than or equal to 5 years', () => {
        ...
        expect(chooseGranularityBasedOnDateRange({ earliestDate: earliestDate, dateRange: dateRange })).toBe('month');
    });
    ...
    it('should return "week" for date ranges over 90 days but less than or equal to 2 years', () => {
        ...
        expect(chooseGranularityBasedOnDateRange({ earliestDate: earliestDate, dateRange: dateRange })).toBe('week');
    });
    ...
    it('should return "day" for date ranges less than or equal to 90 days', () => {
        ...
        expect(chooseGranularityBasedOnDateRange({ earliestDate: earliestDate, dateRange: dateRange })).toBe('day');
    });
