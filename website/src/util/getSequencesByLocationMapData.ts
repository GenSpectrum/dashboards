...
export function getSequencesByLocationMapData(mapName: string | undefined): MapData | undefined {
    ...
    const absoluteMapUrl = new URL(mapData.mapSource.url, window.location.href);
    return {
        ...mapData,
        mapSource: {
            ...mapData.mapSource,
