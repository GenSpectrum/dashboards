...
describe('RadioSelect', () => {
    ...
    it('renders all options', async () => {
        ...
        await expect.element(getByText('Option 1')).toBeInTheDocument();
        await expect.element(getByText('Option 2')).toBeInTheDocument();
        await expect.element(getByText('Option 3')).toBeInTheDocument();
    });
