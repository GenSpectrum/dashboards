...
export function JaccardIndexInfo() {
    return (
        <div className='relative p-8'>
            ...
            <h1 className='mb-2 text-xl font-semibold'>Jaccard Index</h1>
            <p className='text-gray-700'>
...
export function MinProportionInfo() {
    return (
        <div className='relative p-8'>
            ...
            <h1 className='mb-2 text-xl font-semibold'>Minimum Proportion</h1>
            <p className='text-gray-700'>
...
export function MinCountInfo() {
    return (
        <div className='relative p-8'>
            ...
            <h1 className='mb-2 text-xl font-semibold'>Minimum Overall Count</h1>
            <p className='text-gray-700'>
